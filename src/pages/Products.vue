<template>
  ...
  <section
    ...
    style="background-image: url(@/assets/images/heading-pages-02.jpg)"
  >
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
          <div class="leftbar p-r-20 p-r-0-sm">
            ...
            <ul class="p-b-54">
              ...
              <li class="p-t-4">
                <a href="#" class="s-text13"> Women </a>
              </li>

              <li class="p-t-4">
                <a href="#" class="s-text13"> Men </a>
              </li>

              <li class="p-t-4">
                <a href="#" class="s-text13"> Kids </a>
              </li>

              <li class="p-t-4">
                <a href="#" class="s-text13"> Accesories </a>
              </li>
            </ul>
            ...
            <div class="filter-color p-t-22 p-b-50 bo3">
              ...
              <ul class="flex-w">
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter1"
                    for="color-filter1"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter2"
                    for="color-filter2"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter3"
                    for="color-filter3"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter4"
                    for="color-filter4"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter5"
                    for="color-filter5"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter6"
                    for="color-filter6"
                  ></label>
                </li>
                ...
                <li class="m-r-10">
                  ...
                  />
                  <label
                    class="color-filter color-filter7"
                    for="color-filter7"
                  ></label>
                </li>
              </ul>
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                ...
                <div class="block2-txt p-t-20">
                  ...
                  <span class="block2-price m-text6 p-r-5"> $92.50 </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                ...
                <div class="block2-txt p-t-20">
                  ...
                  <span class="block2-newprice m-text8 p-r-5"> $15.90 </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                  <img src="@/assets/images/item-14.jpg" alt="IMG-PRODUCT" />
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                <div
                  class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew"
                >
                  <img src="@/assets/images/item-06.jpg" alt="IMG-PRODUCT" />
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                <div
                  class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale"
                >
                  <img src="@/assets/images/item-11.jpg" alt="IMG-PRODUCT" />
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                <div
                  class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew"
                >
                  <img src="@/assets/images/item-12.jpg" alt="IMG-PRODUCT" />
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
              ...
              <div class="block2">
                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                  <img src="@/assets/images/item-15.jpg" alt="IMG-PRODUCT" />
